...
-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('ARTICLE_CREATED', 'ARTICLE_UPDATED', 'ARTICLE_DELETED', 'ARTICLE_PUBLISHED', 'ORDER_CREATED', 'PAYMENT_RECEIVED', 'ORDER_VALIDATED', 'ORDER_CANCELLED', 'WITHDRAWAL_VALIDATED', 'USER_REGISTERED', 'OTP_SENT', 'WHATSAPP_CONNECTED', 'WHATSAPP_DISCONNECTED', 'DROP_CREATED', 'DROP_UPDATED', 'DROP_DELETED', 'DROP_SENT_TO_GROUP', 'WHATSAPP_GROUP_CONFIGURED');

-- CreateEnum
CREATE TYPE "GroupMappingType" AS ENUM ('ALL_ARTICLES', 'CATEGORY_ARTICLES');
...
CREATE TABLE "DropGroupMapping" (
    ...
    CONSTRAINT "DropGroupMapping_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "GroupMapping_groupId_categoryId_key" ON "GroupMapping"("groupId", "categoryId");

-- CreateIndex
CREATE INDEX "DropGroupMapping_dropId_idx" ON "DropGroupMapping"("dropId");

-- CreateIndex
CREATE INDEX "DropGroupMapping_groupId_idx" ON "DropGroupMapping"("groupId");

-- CreateIndex
CREATE INDEX "DropGroupMapping_sentById_idx" ON "DropGroupMapping"("sentById");

-- CreateIndex
CREATE INDEX "DropGroupMapping_sentAt_idx" ON "DropGroupMapping"("sentAt");

-- CreateIndex
CREATE UNIQUE INDEX "DropGroupMapping_dropId_groupId_key" ON "DropGroupMapping"("dropId", "groupId");
...
-- AddForeignKey
ALTER TABLE "WhatsAppGroup" ADD CONSTRAINT "WhatsAppGroup_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DropGroupMapping" ADD CONSTRAINT "DropGroupMapping_dropId_fkey" FOREIGN KEY ("dropId") REFERENCES "Drop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DropGroupMapping" ADD CONSTRAINT "DropGroupMapping_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "WhatsAppGroup"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DropGroupMapping" ADD CONSTRAINT "DropGroupMapping_sentById_fkey" FOREIGN KEY ("sentById") REFERENCES "Admin"("id") ON DELETE CASCADE ON UPDATE CASCADE;
