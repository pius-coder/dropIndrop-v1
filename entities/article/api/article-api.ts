...
export async function getArticle(id: string): Promise<ArticleWithRelations> {
  return apiClient.get<ArticleWithRelations>(`/articles/${id}`);
}
...
export async function getArticleBySlug(
  ...
  return apiClient.get<ArticleWithRelations>(`/articles/slug/${slug}`);
}
...
export async function updateArticleStock(
  ...
  return apiClient.patch<Article>(`/articles/${id}/stock`, { change });
}
...
export async function incrementArticleViews(id: string): Promise<void> {
  return apiClient.post<void>(`/articles/${id}/views`, {});
}
...
export async function incrementClicksToBuy(id: string): Promise<void> {
  return apiClient.post<void>(`/articles/${id}/clicks`, {});
}
...
export async function archiveArticle(id: string): Promise<Article> {
  return apiClient.patch<Article>(`/articles/${id}/archive`, {});
}
...
export async function restoreArticle(id: string): Promise<Article> {
  return apiClient.patch<Article>(`/articles/${id}/restore`, {});
}
